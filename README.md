...
# BoundaryElementMethod.jl: High-order weakly singular boundary element method code
...
- This repository contains the code for the concepts and examples presented in Chapter 5 for analyzing pressure-driven viscous flow in the rigid vessel with varying cross-sections.
